...
(function gitFeedback() {
    ...
    function generateFeedbackLink() {
        ...
        if (meta_data){
            ...
            let type = parts [0];
            let category = parts[1].replace("&", "and");
            let date = parts[2];
