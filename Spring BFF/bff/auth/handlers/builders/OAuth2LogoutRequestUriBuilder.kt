package com.example.bff.auth.handlers.builders

import com.example.bff.props.LogoutProperties
import com.example.bff.props.OAuth2LogoutProperties
...
internal class OAuth2LogoutRequestUriBuilder(
    ...
    override fun getLogoutRequestUri(
        ...
        if (logoutProps?.enabled == false) {
            return postLogoutUri?.toString()?.takeIf { it.isNotBlank() }
        }

        // otherwise, go and get the logout endpoint:
        ...
        // add token hint request parameter to builder
        ...
        // add client id request parameter to builder
        ...
        // add post logout request parameter to builder
    ...
    fun getLogoutEndpointUri(
        ...
        // if logout props exist & rp-initiated logout is enabled, return OAuth2 property logout endpoint
        ...
        // otherwise, if logout props do not exist
