...
internal class CorsProperties(
    ...
    final val maxAge: Long = 3600L // in seconds
...
internal class CsrfProperties {
    ...
    final val CSRF_COOKIE_NAME: String  = "XSRF-TOKEN"
    final val CSRF_HEADER_NAME: String = "X-XSRF-TOKEN"
...
internal class SessionProperties {
    ...
    final val SESSION_COOKIE_NAME: String = "JSESSIONID"
