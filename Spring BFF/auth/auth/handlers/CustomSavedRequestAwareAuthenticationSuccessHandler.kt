...
internal class CustomSavedRequestAwareAuthenticationSuccessHandler(
    ...
    init {
        // set the custom servlet request cache here
        super.setRequestCache(servletRequestCache)
    }
    ...
    private fun manageSession(
        ...
        session?.let {
            ...
            request.getSession()?.setMaxInactiveInterval(sessionProperties.SESSION_MAX_AGE)
