package com.example.authorizationserver.auth.repositories.clientregistrations
...
internal class ClientRegistrationRepository(
    ...
    fun servletClientRegistrationRepository(): ClientRegistrationRepository {
        return InMemoryClientRegistrationRepository(googleAuthRegistration())
    }

    // Google OAuth2.0 Authentication Provider
    private fun googleAuthRegistration(): ClientRegistration {
        return CommonOAuth2Provider.GOOGLE.getBuilder("google")
            .clientId(clientSecurityProperties.googleClientId)
            .clientSecret(clientSecurityProperties.googleClientSecret)
            .build()
    }
