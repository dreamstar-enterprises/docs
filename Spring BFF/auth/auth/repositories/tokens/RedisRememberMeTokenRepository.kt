...
internal class RedisRememberMeTokenRepository(
     ...
     */
    companion object {
        private const val TOKEN_VALID_DAYS = 14
        private val stringRedisSerializer = StringRedisSerializer()
        private const val USERNAME = "username"
        private const val TOKEN = "token"
        private const val LAST_USED_DATE = "last_used_date"
        private const val NAME_SPACE = "spring:session:in-house-auth-server:rememberMe:token:"
    }
