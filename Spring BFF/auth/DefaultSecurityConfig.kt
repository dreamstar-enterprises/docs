...
import com.example.authorizationserver.auth.repositories.RedisRememberMeTokenRepository
...
internal class DefaultSecurityConfig () {
    ...
    private lateinit var rememberMeTokenKey: String
...
//            rememberMe.key(rememberMeTokenKey)
